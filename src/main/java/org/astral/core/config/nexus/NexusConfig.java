...
public class NexusConfig {
    public String server_path = WorkspaceSetup.tryAutoDetectPathServer();
    ...
    public NexusConfig() {
        ...
        watchers.put(WorkspaceSetup.getDefaultPrefix(), defaultWatcher);
    }
    ...
    public static class Watcher {
        ...
        public String ApplyActionsOnly; // Se aplicarán las acciones al servidor cuando el tipo de extension de aquí cambie su estado
